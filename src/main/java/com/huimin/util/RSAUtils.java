...
public class RSAUtils {
    ...
    public static void main(String[] args) throws Exception {
		...
		String data ="dsdsfdgfhgjjhgjg";
		byte[] encryptByPrivateKey = RSAUtils.encryptByPrivateKey(data.getBytes(),privateKey);
		byte[] decryptByPublicKey = RSAUtils.decryptByPublicKey(encryptByPrivateKey,publicKey);
		System.out.println("原始数据："+data);
		System.out.println("还原数据："+new String(decryptByPublicKey));
    }
