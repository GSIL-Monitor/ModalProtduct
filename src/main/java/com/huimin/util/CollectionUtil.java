 ...
 * 集合工具类
 * 
 * 作者: zhoubang 日期：2015年3月26日 下午1:32:43
 */
public class CollectionUtil {
     ...
     * @return a {@link java.util.List} object.
     */
    public static <T> List<List<T>> descartes(List<List<T>> crossArgs) {
     ...
     * @param level
     */
    private static <T> void crossRecord(List<List<T>> sourceArgs, int[] record,
            int level) {
