 ...
 * 对象工具类
 * 
 * 作者: zhoubang 日期：2015年3月26日 下午1:34:55
 */
public class ObjectUtils {
    ...
    private static final Object getFieldValue(Object obj, String field)
            throws Exception {
        Object result = null;
     ...
     * @return a T object.
     */
    public static final <T> T fromMap(final Map<String, Object> map,
            Class<T> clazz) {
     ...
     */
    @SuppressWarnings("rawtypes")
    public static final <T> void setValue(final Object object,
            final String field, final T value, final Class paramType) {
        try {
